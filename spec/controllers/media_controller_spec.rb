  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved medium as @medium" do
        ...
        post :create, {:medium => { "comment" => "invalid value" }}, valid_session
        assigns(:medium).should be_a_new(Medium)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested medium" do
        ...
        Medium.any_instance.should_receive(:update).with({ "comment" => "" })
        put :update, {:id => medium.to_param, :medium => { "comment" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the medium as @medium" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Medium.any_instance.stub(:save).and_return(false)
        put :update, {:id => medium.to_param, :medium => { "comment" => "invalid value" }}, valid_session
        assigns(:medium).should eq(medium)
      end
